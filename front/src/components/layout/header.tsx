  ...
  return (
    <header className="bg-white border-b border-gray-200">
      <div className="bg-black text-white text-[16px] p-4 text-center">
        <strong>FRETE GRÁTIS</strong> para todo o Sul nas compras acima de R$
        ...
        <div className="flex items-center">
          <div className="">
            ...
            <div className="flex-1" >
                <div className=" w-full hidden md:flex items-center gap-6 px-6">
                    <div className="flex-1 ">
      ...
      <div
        className={`md:hidden overflow-hidden transition-all duration-200 ease-out ${menuOpened ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}
      >
        <div
          className={`md:hidden transition-all duration-200 ease-out ${menuOpened ? "translate-y-0 pb-6" : "-translate-y-2"}`}
        >
          {menuItems.map((item: menuItem) => (
            <Link key={item.label} href={item.href}>
